...
\begin{document}
    ...
    沿表面传播的折射波为：
    \[
        \mathrm{e}^{i\bm{k}'\cdot\bm{x}} = \mathrm{e}^{-k'z|\cos r|} \cdot \mathrm{e}^{ik'x\tfrac{\sin i}{\sin i_0}},\quad \sin i_0=\frac{n'}{n}
    \]
    设波速为$v'_p$，则：
    \[
    ...
    \]
    代入$\lambda'=6.28\times10^{-5}\,\mathrm{cm}$得：
    \[
        \kappa^{-1}=1.75\times10^{-5}\,\mathrm{cm}
    \]
    ...
    \]
    由题意：$\bm{D}\neq\varepsilon\bm{E}$，$\bm{B}=\mu\bm{H}$。
    ...
    \]
    \[
        k_2 = \frac{\omega n'}{c} = \frac{\omega}{c}\sqrt{(\varepsilon+i\frac{\sigma}{\omega})\mu c^2} = \omega\sqrt{\mu(\varepsilon+i\frac{\sigma}{\omega})}
    \]
    注意到由于$\bm{k}_2=a_x\hat{x}+(a_z+ib_z)\hat{z}$，有：
    \[
        k_2^2 = a_x^2 + (a_z^2 + 2ia_z b_z - b_z^2) = (a_x^2 + a_z^2 - b_z^2) + 2ia_z b_z
    \]
    与$k_2^2=\omega^2\mu\varepsilon+i\omega\mu\sigma$联立得：
    \[
        a_x^2 + a_z^2 - b_z^2 = \omega^2\mu\varepsilon,\quad 2a_z b_z = \omega\mu\sigma
    \]
    代入$a_x^2=(k_1\sin\theta_1)^2=\dfrac{\omega^2}{c^2}\sin^2\theta_1$，解得：
    \[
        a_z^2 = \frac{1}{2}(\omega^2\mu\varepsilon-\frac{\omega^2}{c^2}\sin^2\theta_1) + \frac{1}{2}\sqrt{(\omega^2\mu\varepsilon-\frac{\omega^2}{c^2}\sin^2\theta_1)^2+(\omega\mu\sigma)^2}
    \]
    \[
        b_z^2 = -\frac{1}{2}(\omega^2\mu\varepsilon-\frac{\omega^2}{c^2}\sin^2\theta_1) + \frac{1}{2}\sqrt{(\omega^2\mu\varepsilon-\frac{\omega^2}{c^2}\sin^2\theta_1)^2+(\omega\mu\sigma)^2}
    \]
    介质中的透射波有如下形式：
    \[
    ...
    若导电介质为金属：$\dfrac{\sigma}{\omega\varepsilon}\ll1$

    注意到$a_x^2=\dfrac{\omega^2}{c^2}\sin^2\theta_1=\omega^2\mu_0\varepsilon_0\sin^2\theta_1\sim\omega^2\mu\varepsilon$，则$\omega\mu\sigma\gg\omega\mu\varepsilon-\dfrac{\omega^2}{c^2}\sin^2\theta_1$。
    此时有：
    \[
    ...
    \[
        ...
        \begin{aligned}
            ...
            & E_y = A_y\sin\frac{m\pi x}{a}\cos\frac{n\pi y}{b}\sin(k_z z),\quad m,n\in\mathbb{N} \\
    ...
    \[
        ...
        \begin{aligned}
            ...
            & E_y = A_y\cos\frac{m\pi y}{b},\quad m\in\mathbb{N} \\
    ...
    \[
        ...
        \begin{aligned}
            ...
            & E_y = A_y\mathrm{e}^{-i\omega t}\sin\frac{m\pi x}{a}\cos\frac{n\pi y}{b}\sin\frac{p\pi z}{c},\quad m,n,p\in\mathbb{N} \\
    ...
    则电场能量密度的时间平均值为：
    \[
        \frac{1}{2}\varepsilon_0|\bm{E}|^2 = \frac{1}{4}\varepsilon_0(A_x^2 + A_y^2 + A_z^2)
    \]
    ...
    \[
        ...
        \begin{aligned}
            ...
            & B_y = \frac{1}{i\omega}(k_z A_x - k_x A_z)\mathrm{e}^{-i\omega t}\sin\frac{m\pi x}{a}\cos\frac{n\pi y}{b}\sin\frac{p\pi z}{c},\quad m,n,p\in\mathbb{N} \\
    ...
    \begin{align*}
        ...
        &= \frac{1}{4}\varepsilon_0(A_x^2+A_y^2+A_z^2)
    \end{align*}
    ...
    \begin{itemize}
        ...
        \item[2.(1)]
        设入射波的电场强度振幅为$\bm{E}$，折射波为$\bm{E}'$，反射波为$\bm{E}''$，且入射介质为$(\varepsilon_1,\mu_0)$，折射介质为$(\varepsilon_2,\mu_0)$，则能流密度为：
        \[
            \bm{S} = \sqrt{\frac{\varepsilon_1}{\mu_0}}|\bm{E}|^2\hat{k}
        \]
        \[
            \bm{S}' = \sqrt{\frac{\varepsilon_2}{\mu_0}}|\bm{E'}|^2\hat{k}'
        \]
        \[
            \bm{S}'' = \sqrt{\frac{\varepsilon_1}{\mu_0}}|\bm{E''}|^2\hat{k}''
        \]
