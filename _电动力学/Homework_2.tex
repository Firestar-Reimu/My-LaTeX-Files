...
\begin{document}
    ...
    \begin{itemize}
        ...
        球内电场强度：
        \[
        \bm{E}_1(\bm{r}) = \frac{\bm{P}}{\varepsilon-\varepsilon_0} = \frac{K\bm{r}}{(\varepsilon-\varepsilon_0)r^2}\quad (r<R)
        \]
        球内总电荷量：
        \begin{align*}
            Q
            &= \int_0^R\rho\,\mathrm{d}V \\
            &= \int_0^R\frac{\varepsilon_0}{\varepsilon}\rho_f\cdot4\pi r^2\,\mathrm{d}r \\
            &= \frac{\varepsilon_0 K}{(\varepsilon-\varepsilon_0)r^2}\cdot4\pi r^2\,\mathrm{d}r \\
            &= \frac{4\pi\varepsilon_0KR}{\varepsilon-\varepsilon_0}
        \end{align*}
        球内自由电荷量：
        \[
        Q_f = \frac{\varepsilon}{\varepsilon_0}Q = \frac{4\pi\varepsilon KR}{\varepsilon-\varepsilon_0}
        \]
        球外电场强度：
        \[
        \bm{E_2}(\bm{r}) = \frac{\bm{r}}{4\pi\varepsilon_0}\cdot\frac{Q_f}{r^3} = \frac{\varepsilon KR\bm{r}}{\varepsilon_0(\varepsilon-\varepsilon_0)r^3}\quad (r>R)
        \]
        球内电势分布：
        \[
        \varphi_1(r) = \int_r^R\bm{E}_1\,\mathrm{d}r' + \int_R^{+\infty}\bm{E}_2\,\mathrm{d}r' = \frac{K}{\varepsilon-\varepsilon_0}(\ln\frac{R}{r} + \frac{\varepsilon}{\varepsilon_0})\quad (r<R)
        \]
        球外电势分布：
        \[
        \varphi_2(r) = \int_r^{+\infty}\bm{E}_1\,\mathrm{d}r' = \frac{\varepsilon KR}{\varepsilon_0(\varepsilon-\varepsilon_0)r}\quad (r>R)
        \]
        ...
        \[
        \left.\varphi\right|_{r=R_0} = \frac{Q}{4\pi\varepsilon_0R_0} + \varphi_0,\quad
        \left.\varphi\right|_{r\to{+\infty}} = -E_0 r\cos\theta + \varphi_0
        \]
        则有一般解：
        \[
        ...
        \varphi(r,\theta,\phi) = -E_0 r\cos\theta + \varphi_0 + \sum_{l=0}^{+\infty}B_l r^{-l-1}\mathrm{P}_l(\cos\theta)
        \]
        代入$\left.\varphi\right|_{r=R_0}=\dfrac{Q}{4\pi\varepsilon_0R_0}+\varphi_0$，得：
        \[
        \varphi(r,\theta,\phi) = -E_0 r\cos\theta + \varphi_0 + \frac{Q}{4\pi\varepsilon_0r} + \frac{E_0R_0^3}{r^2}\cos\theta
        \]
        ...
        \left\{
            \begin{aligned}
                &\nabla^2\varphi_1 = \frac{\bm{p}_f}{\varepsilon}\nabla\delta(z),\quad &r<R_0 \\
        ...
        \]
        \[
        r = R_0:\quad \varphi_1 = \varphi_2,\quad \varepsilon_1\frac{\partial\varphi_1}{\partial r} = \varepsilon_2\frac{\partial\varphi_2}{\partial r}
        \]
        分离变量得一般解：
        \[
        \varphi(r,\theta,\phi) = \sum_{l=0}^{+\infty}\left(A_l r^l + B_l r^{-l-1}\right)\mathrm{P}_l(\cos\theta)
        ...
        \[
        \varphi_1 = \frac{p_f\cos\theta}{4\pi\varepsilon_1r^2} + \sum_{l=0}^{+\infty}A_l r^l\mathrm{P}_l(\cos\theta),\quad
        \varphi_2 = \frac{p_f\cos\theta}{4\pi\varepsilon_2r^2} + \sum_{l=0}^{+\infty}B_l r^{-l-1}\mathrm{P}_l(\cos\theta)
        \]
        考虑到$r=R_0$处的边界条件，$l\neq1$时：
        \[
        A_lR_0^l = B_lR_0^{-l-1}
        \]
        \[
        \varepsilon_1lA_lR_0^{l-1} = \varepsilon_2(-l-1)B_lR_0^{-l-2}
        \]
        即需要同时满足：
        \[
        A_l = B_lR_0^{-2l-1} = B_l\frac{\varepsilon_2(-l-1)}{\varepsilon_1l}R_0^{-2l-3}
        \]
        只可能是$A_l=B_l=0$。

        而$l=1$时：
        \[
        \frac{p_f}{4\pi\varepsilon_1R_0^2} + A_1R_0 = \frac{p_f}{4\pi\varepsilon_2R_0^2} + \frac{B_1}{R_0^2}
        \]
        \[
        -\frac{2p_f}{4\pi R_0^3} + \varepsilon_1A_1 = -\frac{2p_f}{4\pi R_0^3} - \frac{2\varepsilon_2B_1}{R_0^3}
        \]
        解得：
        \[
        A_1 = \frac{p_f(\varepsilon_1 - \varepsilon_2)}{2\pi\varepsilon_1(\varepsilon_1 + 2\varepsilon_2)R_0^3},\quad
        B_1 = \frac{p_f(\varepsilon_2 - \varepsilon_1)}{4\pi\varepsilon_2(\varepsilon_1 + 2\varepsilon_2)}
        \]
        最后得到电势分布：
        \[
        \left\{
            \begin{aligned}
                &\varphi_1 = \frac{p_f\cos\theta}{4\pi\varepsilon_1 r^2} + \frac{p_f(\varepsilon_1 - \varepsilon_2)r\cos\theta}{2\pi\varepsilon_1(\varepsilon_1 + 2\varepsilon_2)R_0^3},\quad &r<R_0 \\
                &\varphi_2 = \frac{3p_f\cos\theta}{4\pi(\varepsilon_1 + 2\varepsilon_2)r^2},\quad &r>R_0
            \end{aligned}
        \right.
        \]
        由$\dfrac{p}{p_f}=\dfrac{p_p+p_f}{p_f}=\dfrac{\varepsilon_0}{\varepsilon_1}$及$\sigma_p=\varepsilon_0\bm{n}\cdot(\bm{E}_2-\bm{E}_1)$得极化电荷分布：
        \[
        \left\{
            \begin{aligned}
                &\bm{p}_p = \frac{\varepsilon_0 - \varepsilon_1}{\varepsilon_1}\bm{p}_f,\quad &r=0 \\
                &\sigma_p = \frac{3\varepsilon_0(\varepsilon_1 - \varepsilon_2)p_f}{2\pi\varepsilon_1(\varepsilon_1 + 2\varepsilon_2)R_0^3},\quad &r=R_0
            \end{aligned}
        \right.
        \]
        ...
        由静电屏蔽，$R_1<r<R_2$时电势$\varphi_2$为常数，$r>R_2$时必然有$\varphi_3=\dfrac{q}{4\pi\varepsilon_0r}$，又因为电势法向连续：
        \[
        \varphi_2 = \left.\varphi_3\right|_{r=R_2} = \frac{q}{4\pi\varepsilon_0R_2}
        \]
        电势满足的方程为：
        \[
        \left\{
            \begin{aligned}
                &\nabla^2\varphi_1 = \frac{1}{\varepsilon_0}\bm{p}\cdot\nabla\delta(\bm{z}),\quad &r<R_1 \\
                &\varphi_2 = \frac{q}{4\pi\varepsilon_0R_2},\quad &R_1<r<R_2 \\
                &\varphi_3 = \frac{q}{4\pi\varepsilon_0r},\quad &r>R_2
            \end{aligned}
        \right.
        \]
        对于$\varphi_1$，边界条件为：
        \[
        \left.\varphi_1\right|_{r=0} = +\infty,\quad
        \left.\varphi_1\right|_{r=R_1} = \left.\varphi_2\right|_{r=R_1} = \frac{q}{4\pi\varepsilon_0R_2}
        \]
        则$\varphi_1$可以看作电偶极子产生的电势$\dfrac{p\cos\theta}{4\pi\varepsilon_0r^2}$与极化电势的叠加，且极化电势满足Laplace方程$\nabla^2\varphi_1=0$，其一般解为：
        \[
        \varphi_1 = \frac{p\cos\theta}{4\pi\varepsilon_0r^2} + \sum_{l=0}^{+\infty}A_l r^l\mathrm{P}_l(\cos\theta)
        \]
        代入$r=R_1$处的边界条件得：
        \[
        \frac{p\cos\theta}{4\pi\varepsilon_0R_1^2} + \sum_{l=0}^{+\infty}A_l r^l\mathrm{P}_l(\cos\theta) = \frac{q}{4\pi\varepsilon_0R_2}
        \]
        显然有：
        \[
        A_0 = \frac{q}{4\pi\varepsilon_0R_2},\quad
        ...
        \left\{
            \begin{aligned}
                &\varphi_1 = \frac{q}{4\pi\varepsilon_0R_2} + \frac{\bm{p}\cdot\bm{r}}{4\pi\varepsilon_0}\left(\frac{1}{r^3} - \frac{1}{R_1^3}\right),\quad &r<R_1 \\
                &\varphi_2 = \frac{q}{4\pi\varepsilon_0R_2},\quad &R_1<r<R_2 \\
                &\varphi_3 = \frac{q}{4\pi\varepsilon_0r},\quad &r>R_2
            \end{aligned}
            \right.
        ...
        \left\{
            \begin{aligned}
                &\bm{E}_1 = \frac{p\cos\theta}{4\pi\varepsilon_0}\left(\frac{2}{r^3} + \frac{1}{R_1^3}\right),\quad &r<R_1 \\
                &\bm{E}_2 = 0,\quad &R_1<r<R_2 \\
                &\bm{E}_3 = \frac{q}{4\pi\varepsilon_0r^2},\quad &r>R_2
            \end{aligned}
        \right.
        \]
        面电荷分布：
        \[
        r=R_1:\quad \sigma_1 = \left.\varepsilon_0\bm{n}\cdot(\bm{E}_2 - \bm{E}_1)\right|_{r=R_1} = \varepsilon(0 - \frac{3p\cos\theta}{4\pi\varepsilon_0R_1^3}) = \frac{3p\cos\theta}{4\pi R_1^3}
        \]
        \[
        r=R_2:\quad \sigma_2 = \left.\varepsilon_0\bm{n}\cdot(\bm{E}_3 - \bm{E}_2)\right|_{r=R_2} = \varepsilon(0 - \frac{q}{4\pi\varepsilon_0R_2^2}) = \frac{q}{4\pi R_2^2}
        \]
        ...
        \left\{
            \begin{aligned}
                &\varphi = \frac{1}{4\pi\varepsilon_0}\left(\frac{q}{\sqrt{r^2+a^2-2ar\cos\theta}} - \frac{R_1q}{\sqrt{a^2r^2+R_1^4-2arR_1^2\cos\theta}}\right),\quad &r<R_1 \\
                &\varphi = 0,\quad &r\geqslant R_1
            \end{aligned}
        \right.
        \]
        此时球心电势$\left.\varphi\right|_{r=0}=\dfrac{q}{4\pi\varepsilon_0}\left(\dfrac{1}{a}-\dfrac{1}{R_1}\right)<+\infty$保证有限。
        ...
        \begin{center}
            \begin{tikzpicture}
                ...
                \draw [dashed] (-1.8,0) arc [start angle=180, end angle=360, radius=1.8];
                \fill (0,2.7) circle [radius=2pt] node [right] {$q$};
                \fill (0,1.2) circle [radius=2pt] node [right] {$q_3$};
                \fill (0,-1.2) circle [radius=2pt] node [right] {$q_2$};
                \fill (0,-2.7) circle [radius=2pt] node [right] {$q_1$};
            \end{tikzpicture}
        \end{center}
        其中像电荷的电荷量分别为：
        \[
        ...
        故电势分布为：
        \[
        \varphi = \frac{1}{4\pi\varepsilon_0}\left[\frac{q}{\sqrt{x^2+y^2+(z-b)^2}} - \frac{q}{\sqrt{x^2+y^2+(z+b)^2}} + \frac{qa/b}{\sqrt{x^2+y^2+(z+a^2/b)^2}} - \frac{qa/b}{\sqrt{x^2+y^2+(z-a^2/b)^2}}\right]
        \]
        ...
        \begin{center}
            \begin{tikzpicture}[>=Stealth]
                ...
                \fill (2.5,1.5) circle [radius=2pt] node [anchor=south west] {$q$};
                \fill (-2.5,1.5) circle [radius=2pt] node [anchor=south east] {$-q$};
                \fill (-2.5,-1.5) circle [radius=2pt] node [anchor=north east] {$q$};
                \fill (2.5,-1.5) circle [radius=2pt] node [anchor=north west] {$-q$};
        ...
        \begin{align*}
        \varphi
        &= \frac{1}{4\pi\varepsilon_0}\left[\frac{q}{\sqrt{(x-a)^2+(y-b)^2+z^2}} - \frac{q}{\sqrt{(x-a)^2+(y+b)^2+z^2}} \right. \\
    ...
    \begin{itemize}
        ...
        电势的领头阶为偶极矩的贡献：
        \[
        \varphi = \frac{1}{4\pi\varepsilon_0}\left(\frac{\bm{p}\cdot\bm{r}}{r^3}\right) = \frac{1}{4\pi\varepsilon_0}\left(\frac{(l_1\hat{x} + l_2\hat{y})q}{r^3}\right) = \frac{1}{4\pi\varepsilon_0}\left(\frac{(l_1\sin\theta\cos\phi+l_2\sin\theta\sin\phi)q}{r^3}\right)
        \]
        其电场强度与$r^3$成反比。
        ...
        电势的领头阶为偶极矩的贡献：
        \[
        \varphi = \frac{1}{4\pi\varepsilon_0}\left(\frac{\bm{p}\cdot\bm{r}}{r^3}\right) = \frac{1}{4\pi\varepsilon_0}\left(\frac{(2l_1\hat{x} + l_2\hat{y})q}{r^3}\right) = \frac{1}{4\pi\varepsilon_0}\left(\frac{(2l_1\sin\theta\cos\phi+l_2\sin\theta\sin\phi)q}{r^3}\right)
        \]
        其电场强度与$r^3$成反比。
