...
\begin{document}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.4\linewidth]{dijkstraf.png}
	\end{figure}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.4\linewidth]{mst1.png}
	\end{figure}	
	
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.4\linewidth]{mst2.png}
	\end{figure}
