...
\begin{enumerate}
    ...
    \[
        f_\beta = \frac{f_{\alpha 0}}{1 + z_\beta}
    \]
    而$f_{\beta0}$的真实红移应与$f_{\alpha0}$相同，即$z_\alpha=\dfrac{v_\alpha}{c}$，于是有：
    \[
        f_{\beta0} = f_\beta(1 + z_\alpha) = \frac{f_{\alpha 0}}{1 + z_\beta}(1 + z_\alpha) = f_{\alpha0}\frac{c + v_\alpha}{c + v_\beta} = 99.225\,\mathrm{GHz}
    \]
    ...
    \bigskip
    \item[4.]
    由电偶极跃迁的选择定则，$4\mathrm{p}$态可以跃迁的路径如下：4p-3s, 4p-3d, 4p-2s, 4p-1s, 3s-2p, 3d-2p, 2p-1s

    则它可以有5种谱线：（注意3s-2p和3d-2p产生同一谱线）
    \begin{align*}
        &\mathrm{P}\alpha\quad \lambda_{4 \to 3} = 1875.63\,\mathrm{nm} \\
        &\mathrm{H}\beta\quad \lambda_{4 \to 2} = 486.27\,\mathrm{nm} \\
        &\mathrm{Ly}\gamma\quad \lambda_{4 \to 1} = 97.25\,\mathrm{nm} \\
        &\mathrm{H}\alpha\quad \lambda_{3 \to 2} = 656.47\,\mathrm{nm} \\
        &\mathrm{Ly}\alpha\quad \lambda_{2 \to 1} = 121.57\,\mathrm{nm}
    \end{align*}

    同理，$4\mathrm{s}$态可以跃迁的路径如下：4s-3p, 4s-2p, 3p-2s, 3p-1s, 2p-1s

    则它可以有5种谱线：
    \begin{align*}
        &\mathrm{P}\alpha\quad \lambda_{4 \to 3} = 1875.63\,\mathrm{nm} \\
        &\mathrm{H}\beta\quad \lambda_{4 \to 2} = 486.27\,\mathrm{nm} \\
        &\mathrm{Ly}\beta\quad \lambda_{3 \to 1} = 102.57\,\mathrm{nm} \\
        &\mathrm{H}\alpha\quad \lambda_{3 \to 2} = 656.47\,\mathrm{nm} \\
        &\mathrm{Ly}\alpha\quad \lambda_{2 \to 1} = 121.57\,\mathrm{nm}
    \end{align*}
