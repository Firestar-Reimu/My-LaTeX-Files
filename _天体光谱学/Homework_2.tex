...
\begin{enumerate}
    ...
    (a) 漫线系：
    $4\,^2D_{5/2} \rightarrow 3\,^2P_{3/2}$，$4\,^2D_{3/2} \rightarrow 3\,^2P_{3/2}$，$4\,^2D_{3/2} \rightarrow 3\,^2P_{1/2}$。

    (b) 基线系：
    $5\,^2F_{7/2} \rightarrow 3\,^2D_{5/2}$，$5\,^2F_{5/2} \rightarrow 3\,^2D_{5/2}$，$5\,^2F_{5/2} \rightarrow 3\,^2D_{3/2}$。

    (c) $\Delta L=2$不符合选择定则$\Delta L=0,\pm 1$

    (d) 主线系：
    $4\,^2P_{3/2} \rightarrow 4\,^2S_{1/2}$，$4\,^2P_{1/2} \rightarrow 4\,^2S_{1/2}$。
    ...
    \]
    其中$Z_{\mathrm{eff}}=6-3+1=4$，$\mu$为约化质量

    量子亏损的重要性：直观解释了穿透效应，解释了为何碱金属外层电子的能级偏离氢原子的情况
    ...
    \bigskip
    \item[5.]
    只需要考虑$\mathrm{3d5p}$轨道上的孤电子，它们有$l_1=2$，$l_2=1$，$s_1=s_2=\dfrac{1}{2}$，相互组合就能产生$L=1,2,3$，$S=0,1$，则可以产生的光谱项有：$\mathrm{^1P}$，$\mathrm{^1D}$，$\mathrm{^1F}$，$\mathrm{^3P}$，$\mathrm{^3D}$，$\mathrm{^3F}$，其中能量最低的光谱项为$\mathrm{3^F}$，能级为$\mathrm{^3F_2}$，$\mathrm{^3F_3}$，$\mathrm{^3F_4}$
