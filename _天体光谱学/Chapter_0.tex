...
\begin{slide}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            $n=1$时的轨道半径又称为\textbf{Bohr半径}$a_{\mathrm{B}}\approx0.52918\,\symbol{"212B}$
        \end{itemize}
    \end{itemize}
\end{slide}
...
\begin{slide}
    \begin{itemize}
        ...
        得轨道半径为：
        \[
            r_1 = \frac{4\pi\epsilon_0\hbar^2}{\mu Ze^2} = \frac{a_{\mathrm{B}}}{Z},\quad r_n = n^2r_1 = \frac{n^2 a_{\mathrm{B}}}{Z}
        \]
