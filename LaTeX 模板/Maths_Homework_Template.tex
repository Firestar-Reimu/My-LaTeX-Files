...
% \usepackage[bold-style=ISO,sans-style=italic]{unicode-math}
% \setmathfont[StylisticSet={6,9,10}]{Garamond-Math.otf}
% \AtBeginDocument{
%   \let\uglymathbf\mathbf
%   \renewcommand\mathbf\symbf
%   \let\uglymathsf\mathsf
...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \begin{equation}
            \mathsf{M} =
            \begin{bmatrix}
                \dfrac{1+\sqrt{3}}{2} & \mathrm{e}^{-i\omega t} \\
                -\mathrm{e}^{-i\omega t} & \dfrac{1-\sqrt{3}}{2}
            \end{bmatrix}
        \end{equation}

        \textparagraph\ An example of intergals:
        \begin{equation}
        \iiint \nabla \cdot \mathbf{\varPhi} \,\mathrm{d}V = \oiint \mathbf{\varPhi}\,\mathrm{d}\mathbf{S}
        \end{equation}
