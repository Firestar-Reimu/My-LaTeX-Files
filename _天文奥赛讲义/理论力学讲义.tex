...
\]
Laplace-Runge-Lenz矢量与离心率有密切关系。定义\textbf{离心率矢量}$\bm{e} = \dfrac{\bm{M}}{m^2\alpha}$，其大小等于离心率$e$，方向沿从焦点到近日点的方向：
\[
...
\begin{figure}[ht!]
    ...
    \begin{tikzpicture}
        ...
        \addplot3 [contour lua={levels={1.397, 1.42, 1.5, 1.6456751, 1.7782065, 1.9600748, 2.5, 3.5}, labels=false, draw color=black}] {0.5*(x^2+y^2) + 0.7/(sqrt((x-0.3)^2+y^2)) + 0.3/(sqrt((x+0.7)^2+y^2))};
