...
\begin{center}
    \begin{tikzpicture}[>=Stealth]
        ...
        \draw[->,color=blue] (1.125,0.649519) -- (3.464102,2) node[anchor=west,rotate=30]{$x'$};
        ...
        \draw[color=blue] (2.424038,1.399519) node[anchor=north west,rotate=30] {$x'$};
        ...
        \draw[color=brown] (0,0) -- (1.125,0.649519) node[midway,above,rotate=30] {$x\cos\epsilon$};
        ...
        \draw[dashed,color=orange] (0,3) -- (0.375,2.350481) node[midway,right,rotate=30] {$x\sin\epsilon$};
