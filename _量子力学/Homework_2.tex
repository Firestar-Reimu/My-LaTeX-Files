...
\maketitle
    ...
    \begin{itemize}
        ...
        \]
        如果$E < \min{V(x)}$，则$\dfrac{2m}{\hbar^2}[V(x) - E] > 0$，$\psi$与$\displaystyle \psi''(x) = \dv[2]{\psi}{x}$同号。
    ...
    \begin{itemize}
        ...
        \begin{align*}
            \expval{x}
            &= \int_{-\infty}^{+\infty} \Psi^* x \Psi \dd{x} \\
        ...
        \begin{align*}
            \expval{x^2}
            &= \int_{-\infty}^{+\infty} \Psi^* x^2 \Psi \dd{x} \\
        ...
        \[
            \Psi(x,t) = \sqrt[4]{\frac{2a}{\pi}} \frac{1}{\gamma} \exp[-\frac{a}{\gamma^2}\left(x - \frac{hlt}{m}\right)^2 + il\left(x - \frac{hlt}{2m}\right)],\quad \gamma = \sqrt{1 + \frac{2ai\hbar t}{m}}
        \]
        记$\theta = \dfrac{2a\hbar t}{m}$，则$\gamma = \sqrt{1+i\theta}$，$t = 0$时$\gamma = 1$，于是：
        \begin{align*}
            \Phi(p,0)
            &= \frac{1}{\sqrt{2\pi\hbar}} \int_{-\infty}^{+\infty} \mathrm{e}^{-\tfrac{ipx}{\hbar}} \Psi(x,0) \dd{x} \\
            &= \frac{1}{\sqrt{2\pi\hbar}} \int_{-\infty}^{+\infty} \sqrt[4]{\frac{2a}{\pi}} \exp[-ax^2 + ilx - \frac{ipx}{\hbar}] \dd{x} \\
        ...
        \begin{align*}
            ...
            &= K \frac{\gamma\sqrt{\pi}}{\sqrt{a}} \exp[-\frac{a}{\gamma^2} \left(\frac{hlt}{m}\right)^2 + il \frac{hlt}{2m}] \exp[-\frac{\gamma^2}{4a}\left(l - \frac{p}{\hbar}\right)^2 - i\left(l - \frac{p}{\hbar}\right)\left(\frac{hlt}{m}\right) + \frac{a}{\gamma^2}\left(\frac{hlt}{m}\right)^2] \\
            &= \frac{1}{\sqrt{2a\hbar}} \sqrt[4]{\frac{2a}{\pi}} \exp[-\frac{\gamma^2}{4a} \left(l - \frac{p}{\hbar}\right)^2 - \frac{ihlt}{2m} \left(l - \frac{2p}{\hbar}\right)]
        \end{align*}
        注意到$\gamma^2 = 1 + i\theta = 1 + i\theta(t)$，$t = 0$时$\gamma^2 = 1$，且$\gamma^2 + \left(\gamma^2\right)^* = 2\Re\left(\gamma^2\right) = 2$，于是有：
        \[
            \abs{\Phi(p,0)}^2 = \abs{\Phi(p,t)}^2 = \frac{1}{\hbar\sqrt{2a\pi}} \exp[-\frac{1}{2a}\left(l-\frac{p}{\hbar}\right)^2]
        ...
        而对于静态高斯波包的波函数：
        \[
            \Psi_0(x,t) = \sqrt[4]{\frac{2a}{\pi}} \frac{1}{\gamma} \exp(-\frac{a}{\gamma^2}x^2),\quad \gamma = \sqrt{1 + \frac{2ai\hbar t}{m}}
        \]
