    ...
    \begin{itemize}
        ...
        \begin{center}
            \begin{tikzpicture}[>=Stealth]
                ...
                \draw (10,0) ++(180:3) arc [start angle=180,radius=3,delta angle=-8.13010];
                \draw (0,0) ++(0:1) arc [start angle=0,radius=1,delta angle=18.43495];
                \draw (3,1) ++(-8.13010:0.9) arc [start angle=-8.13010,radius=0.9,delta angle=26.56505];
                \draw (6.75,0.25) node {$\theta_{\mathrm{E}}$};
                \draw (4.1,1.1) node {$\alpha$};
